  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#060d1a]">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -bottom-20 right-[15%] h-[380px] w-[380px] rounded-full bg-[#FF6B35]/18 blur-[110px]" />
      ...
      <div className="pointer-events-none absolute top-0 inset-x-0 h-px bg-linear-to-r from-transparent via-[#FF6B35]/40 to-transparent" />
      ...
      >
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          <div className="relative mb-5">
            <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-[#1A3C8A] to-[#FF6B35] blur-[18px] opacity-60" />
            <div className="relative flex h-[60px] w-[60px] items-center justify-center rounded-2xl bg-linear-to-br from-[#1A3C8A] to-[#FF6B35] shadow-[0_20px_40px_-12px_rgba(255,107,53,0.45)]">
